import{_ as n,o as s,c as a,e}from"./app-62e0d7e4.js";const t={},p=e(`<h1 id="array-prototype-reduce-迭代" tabindex="-1"><a class="header-anchor" href="#array-prototype-reduce-迭代" aria-hidden="true">#</a> Array.prototype.reduce() | 迭代</h1><h2 id="语法" tabindex="-1"><a class="header-anchor" href="#语法" aria-hidden="true">#</a> 语法</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>    arr<span class="token punctuation">.</span><span class="token function">reduce</span><span class="token punctuation">(</span>callback<span class="token punctuation">[</span><span class="token punctuation">,</span> initialValue<span class="token punctuation">]</span><span class="token punctuation">)</span>
